...
<!--            <span>8</span>-->
      ...
      <div class="con-right fr">
        <div class="right-top">
          <div class="title">本日行驶里程TOP5</div>
          <img src="../../../img/bj-1.png" alt="" class="bj-1">
          <img src="../../../img/bj-2.png" alt="" class="bj-2">
          <img src="../../../img/bj-3.png" alt="" class="bj-3">
          <img src="../../../img/bj-4.png" alt="" class="bj-4">
  ...
  methods: {
    echarts_1() {
      ...
      option = {
        ...
        color: ['#af89d6', '#4ac7f5','#44aff0','#4777f5', '#ad46f3'],
        legend: { //图例组件，颜色和名字
          x: '70%',
          y: 'center',
          orient: 'vertical',
        ...
        series : [
          {
            ...
            data:[0, 0, 0,0, 0, 0, 0, 0, 0, 80, 120, 130,90, 80, 90,110, 123,102, 70,0, 0, 0, 0, 0]
          }
        ]
      };
      ...
      option = {
        ...
        series : [

          {
            ...
            roseType : 'area',
            data:[
              {value:35, name:'11645345654'},
              {value:32, name:'11642422160'},
              {value:31, name:'11645547259'},
              {value:30, name:'11645521957'},
              {value:30, name:'11642401370'}
    ...
    echarts_6() {
      ...
      option = {
        ...
        tooltip: {
          ...
          formatter: function(params) {
            return params[0]["data"].name + "<br/>" + '报警车次: ' + params[1]["data"].value ;
          }
        },
        xAxis: [{
          type: 'category',
...
<style scoped>
@import '../../../src/sytles/common.css';
@import '../../../src/sytles/map.css';
</style>
