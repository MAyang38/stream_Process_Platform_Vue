<template>
	...
	<div id="UserInfo">
      ...
      <el-descriptions  direction="vertical" :column="4" border>
        <el-descriptions-item label="terminal_phone">11653359825</el-descriptions-item>
        <el-descriptions-item label="terminal_name">HB_K138#</el-descriptions-item>
        <el-descriptions-item label="belong_type">卡车</el-descriptions-item>
        <el-descriptions-item label="mining_area">宏斌煤矿</el-descriptions-item>
        <el-descriptions-item label="belong_fleet">一队</el-descriptions-item>
        <el-descriptions-item label="daokuangdate">2021-12-01T16:00:00.000Z</el-descriptions-item>
